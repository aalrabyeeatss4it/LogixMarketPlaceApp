              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                      ...
                      children: [
                        Text(itemModel.getPriceIncludeVat,style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w900,color: primaryColor),),
                  ...
                  Row(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text('quantity'.tr, style: const TextStyle(fontSize: 14, color:  Colors.grey)),
                        Text(itemModel.getQuantity, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w900,color: primaryColor)),
                      ]
                  ),
                ],
              ),
